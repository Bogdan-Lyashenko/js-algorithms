...
class Example {
    ...
    testFirstExampleSearch() {
        ...
        //goal node id#4
        var resultNode = BreadthFirstSearch.search(root, {id: 4});
        console.log(resultNode);

        //other tests
        console.log(BreadthFirstSearch.search(root, {id: 7}));
        console.log(BreadthFirstSearch.search(root, {id: 7}));
        console.log(BreadthFirstSearch.search(root, {id: 2}));
        console.log(BreadthFirstSearch.search(root, {id: 8}));
    }
}
